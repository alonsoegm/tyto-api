...
/// <summary>Validates <see cref="LanguageModelUpdateDto"/>. Same rules as create.</summary>
public class LanguageModelUpdateValidator : AbstractValidator<LanguageModelUpdateDto>
{
    public LanguageModelUpdateValidator()
    {
        ...
        RuleFor(x => x.UserAssignedClientId)
            ...
            .When(x => x.AuthenticationMethod == AuthenticationMethod.ManagedIdentity && x.ManagedIdentityType == Domain.Enums.ManagedIdentityType.UserAssigned);
    }
